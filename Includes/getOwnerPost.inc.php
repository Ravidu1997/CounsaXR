...
$postDetails = getPostForCounselor($conn, $userid);
$displayIndex = 0;
    ...
    <div class="col-12 col-sm-6 col-md-6 col-lg-3 mt-3">
        ...
        <div class="card" style="max-height: 1000px;">
            ...
            <div class="container">
                ...
                <span class="pl-1">5.0</span><div class="modal-footer"><button type="button" class="btn btn-primary">Edit Post</button></div>
            </div>
        </div>
    </div>
  <!--end of card1-->
